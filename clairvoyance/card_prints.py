...
def clairvoyante_sort_cards(name, chosed_card_deck, chosed_theme, menu):
    ...
    def create_final_response(list_of_cards, menu, name, list_of_polarity, chosed_card_deck):      
        ...
        important_card = response_card(name, index_result_card, chosed_theme, menu)
    ...
    if chosed_theme == 'love':     
        ...
        for i in chosed_card_deck:
            ...
            message_card = create_cards_message(card[1], card[0], card[2], card[4])
    ...
    if chosed_theme == 'work':
        ...
        for i in chosed_card_deck:        
            card = get_from_db(i)        
            list_of_polarity.append(card[6])
            message_card = create_cards_message(card[1], card[0], card[2], card[5])
            list_of_cards.append(message_card[0])
    ...
    if chosed_theme == 'gen':
        ...
        for i in chosed_card_deck:        
            card = get_from_db(i)        
            list_of_polarity.append(card[6])
            message_card = create_cards_message(card[1], card[0], card[2], card[3])
            list_of_cards.append(message_card[0])
